...
void hillClimbingFunc::makeState(int* state, int len,
...
bool hillClimbingFunc::EstimatedCost(int facilityCount, int customerCount,
  ...
  // vector<pair<int, int>> sortDemand;
  // for (int i = 0; i < customerCount; i++) {
  //   sortDemand.push_back(make_pair(customerDemand[i], i));
  // }
  // sort(sortDemand.begin(), sortDemand.end());
...
size_t hillClimbingFunc::calcCost(int facilityCount, int customerCount,
                                  int facility[][2], int* customerDemand,
                                  int** customerCost, int* facilityState,
                                  int* customerState) {
  int totalCap = 0;
...
void hillClimbing(int facilityCount, int customerCount, int facility[][2],
  ...
  hillClimbingFunc::makeState(
      facilityState, facilityCount, [&](int* facilityState) -> bool {
        return hillClimbingFunc::EstimatedCost(facilityCount, customerCount,
